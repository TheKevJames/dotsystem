# yoinked from https://github.com/pawel-slowik/zsh-async-git-prompt/blob/77f6ba8849cc16b20646dddde624303d40286c86/async-git-prompt.plugin.zsh
# modifications:
#   GIT_PROMPT_FIFO_DIR -> move to /tmp
#   GIT_PROMPT_SYMBOLS  -> 256bit to 8bit color:
#        9 -> 1
#       10 -> 2
#      117 -> 6
#      120 -> 2
...
GIT_PROMPT_FIFO_DIR="/tmp/zsh-git-prompt"
